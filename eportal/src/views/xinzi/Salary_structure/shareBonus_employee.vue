<template>
  <v-container fluid grid-list-xl>
    ...
    <div class="bg">
      ...
      <v-flex md12>
        <v-data-table :headers="headers" no-data-text="无结果!" :items="desserts" class="elevation-1">
...
export default {
  ...
  methods: {
    getBonuswait() {
      this.$axios.get("/api/salaryStructure/bonuswaitInfoSharePersonal",{
    ...
    search() {
      ...
      // 选择年份
        ...
        this.$axios
          .get("/api/salaryStructure/periodshare", {
            params: {
