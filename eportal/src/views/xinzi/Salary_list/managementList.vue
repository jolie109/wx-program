<template>
  <v-container fluid grid-list-xl>
    ...
    <v-layout class="search">
      <v-flex xs12 sm2 md2>
        <v-autocomplete :items="employees" label="请选择/输入员工" v-model="name_chosen"></v-autocomplete>
      </v-flex>
      <v-flex xs12 sm2 md2 ml-2>
        ...
        >
          ...
          <v-date-picker v-model="date" type="month" locale="zh-cn" @input="menu = false"></v-date-picker>
        </v-menu>
      </v-flex>
      <v-flex xs12 sm6 md2>
      ...
      <v-flex md12>
        ...
        >
          <template v-slot:items="props">
            ...
            <td>
              <v-btn small color="primary" class="btn_pay" @click="payclick(props.item)">转为草稿</v-btn>
            </td>
          </template>
        </v-data-table>
      </v-flex>
