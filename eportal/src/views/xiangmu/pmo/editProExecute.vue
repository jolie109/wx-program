        ...
        >
         <template v-slot:items="props">
            <tr>
              ...
              <td v-if="already_sum!=''">{{ already_sum.progress_cc_sum }}</td>
              <td v-else>0</td>
              <td>{{ props.item.complete_cc_point +  props.item.reward_cc_point}}</td>
              <td v-if="already_sum!=''">{{ already_sum.complete_cc_sum }}</td>
              <td v-else>0</td>
            ...
            <tr>
              ...
              <td v-if="already_sum!=''">{{ already_sum.progress_pm_sum }}</td>
              <td>{{ props.item.complete_pm_point + props.item.reward_cc_point}}</td>
              <td v-if="already_sum!=''">{{ already_sum.complete_pm_sum }}</td>
              <td v-else>0</td>
        ...
        <v-dialog v-model="dialog" persistent max-width="700">
          <v-card>
            ...
            <v-layout>
              ...
              <v-flex xs6>
                <v-text-field v-model="pro_lineData.product.name"></v-text-field>
              </v-flex>
            </v-layout>
            <v-layout>
              <v-flex lg4 class="row_lab_sty">
